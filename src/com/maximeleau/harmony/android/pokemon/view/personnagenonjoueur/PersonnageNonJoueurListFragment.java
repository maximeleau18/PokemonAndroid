/**************************************************************************
 * PersonnageNonJoueurListFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** PersonnageNonJoueur list fragment.
 *
 * This fragment gives you an interface to list all your PersonnageNonJoueurs.
 *
 * @see android.app.Fragment
 */
public class PersonnageNonJoueurListFragment
        extends HarmonyListFragment<PersonnageNonJoueur>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected PersonnageNonJoueurListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_personnagenonjoueur_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.personnagenonjoueurProgressLayout,
                R.id.personnagenonjoueurListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.personnagenonjoueur_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PersonnageNonJoueurListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PersonnageNonJoueurListLoader(this.getActivity(),
    ...
    public void onClickAdd() {
        Intent intent = new Intent(this.getActivity(),
                    PersonnageNonJoueurCreateActivity.class);
