/**************************************************************************
 * TypeDePokemonShowFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** TypeDePokemon show fragment.
 *
 * This fragment gives you an interface to show a TypeDePokemon.
 * 
 * @see android.app.Fragment
 */
public class TypeDePokemonShowFragment
    ...
    /** Text view for no TypeDePokemon. */
    ...
    protected void initializeComponent(final View view) {
        ...
        this.dataLayout =
                (RelativeLayout) view.findViewById(
                        R.id.typedepokemon_data_layout);
        this.emptyText =
                (TextView) view.findViewById(
                        R.id.typedepokemon_empty);
    }
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(
                        R.layout.fragment_typedepokemon_show,
                        container,
                        false);  
        ...
        this.update((TypeDePokemon) intent.getParcelableExtra(TypeDePokemonContract.PARCEL));
     ...
     *
     * @param item The TypeDePokemon to get the data from.
     */
    public void update(TypeDePokemon item) {
        this.model = item;
        ...
        if (this.model != null) {
            ...
            loader.addUri(Uri.parse(baseUri), new UriLoadedCallback() {
                ...
                public void onLoadComplete(android.database.Cursor c) {
                    TypeDePokemonShowFragment.this.onTypeDePokemonLoaded(c);
                }
            ...
            loader.addUri(Uri.parse(baseUri + "/pokemons"), 
                ...
                @Override
                public void onLoadComplete(android.database.Cursor c) {
                    TypeDePokemonShowFragment.this.onPokemonsLoaded(c);
                }
    ...
    public void onTypeDePokemonLoaded(android.database.Cursor c) {
        if (c.getCount() > 0) {
            ...
            TypeDePokemonContract.cursorToItem(
                        c,
                        this.model);
            this.loadData();
        }
    ...
    /**
     * Calls the TypeDePokemonEditActivity.
     */
    @Override
    public void onClickEdit() {
        final Intent intent = new Intent(getActivity(),
                                    TypeDePokemonEditActivity.class);
        Bundle extras = new Bundle();
        extras.putParcelable(TypeDePokemonContract.PARCEL, this.model);
    ...
    private class DeleteTask extends AsyncTask<Void, Void, Integer> {
        ...
        /** Entity to delete. */
        private TypeDePokemon item;

        /**
         * Constructor of the task.
         * @param item The entity to remove from DB
         * @param ctx A context to build TypeDePokemonSQLiteAdapter
         */
        ...
        protected Integer doInBackground(Void... params) {
            ...
            result = new TypeDePokemonProviderUtils(this.ctx)
                    .delete(this.item);
        ...
        protected void onPostExecute(Integer result) {
            if (result >= 0) {
                TypeDePokemonShowFragment.this.onPostDelete();
            }
