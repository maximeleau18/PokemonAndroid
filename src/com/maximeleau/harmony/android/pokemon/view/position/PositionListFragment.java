/**************************************************************************
 * PositionListFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** Position list fragment.
 *
 * This fragment gives you an interface to list all your Positions.
 *
 * @see android.app.Fragment
 */
public class PositionListFragment
        extends HarmonyListFragment<Position>
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_position_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.positionProgressLayout,
                R.id.positionListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.position_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PositionListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PositionListLoader(this.getActivity(),
