/**************************************************************************
 * PersonnageNonJoueurBadgeListActivity.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/**
 * This class will display PersonnageNonJoueurBadge entities in a list.
 *
 * This activity has a different behaviour wether you're on a tablet or a phone.
 * - On a phone, you will have a PersonnageNonJoueurBadge list. A click on an item will get 
 * you to PersonnageNonJoueurBadgeShowActivity.
 * - On a tablet, the PersonnageNonJoueurBadgeShowFragment will be displayed right next to
 * the list.
 */
public class PersonnageNonJoueurBadgeListActivity 
        extends HarmonyFragmentActivity
        implements HarmonyListFragment.OnClickCallback,
                HarmonyListFragment.OnLoadCallback {

    /** Associated list fragment. */
    protected PersonnageNonJoueurBadgeListFragment listFragment;
    /** Associated detail fragment if any (in case of tablet). */
    protected PersonnageNonJoueurBadgeShowFragment detailFragment;
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        this.detailFragment = (PersonnageNonJoueurBadgeShowFragment) 
                        this.getSupportFragmentManager().findFragmentById(
                                R.id.fragment_show);
        this.listFragment = (PersonnageNonJoueurBadgeListFragment)
                        this.getSupportFragmentManager().findFragmentById(
                                R.id.fragment_list);
    ...
    protected int getContentView() {
        return R.layout.activity_personnagenonjoueurbadge_list;
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (this.isDualMode()) {
            ...
            final Intent intent = new Intent(this, PersonnageNonJoueurBadgeShowActivity.class);
            final PersonnageNonJoueurBadge item = PersonnageNonJoueurBadgeContract
                    .cursorToItem((android.database.Cursor)
                            l.getItemAtPosition(position));
            Bundle extras = new Bundle();
            extras.putParcelable(PersonnageNonJoueurBadgeContract.PARCEL, item);
     ...
     */
    private void loadDetailFragment(PersonnageNonJoueurBadge item) {
    ...
    private void selectListItem(int listPosition) {
        ...
        if (listSize > 0) {
            ...
            PersonnageNonJoueurBadge item = PersonnageNonJoueurBadgeContract.cursorToItem(
