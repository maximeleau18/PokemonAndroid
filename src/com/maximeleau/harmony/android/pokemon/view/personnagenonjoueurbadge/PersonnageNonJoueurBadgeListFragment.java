/**************************************************************************
 * PersonnageNonJoueurBadgeListFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** PersonnageNonJoueurBadge list fragment.
 *
 * This fragment gives you an interface to list all your PersonnageNonJoueurBadges.
 *
 * @see android.app.Fragment
 */
public class PersonnageNonJoueurBadgeListFragment
        extends HarmonyListFragment<PersonnageNonJoueurBadge>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected PersonnageNonJoueurBadgeListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_personnagenonjoueurbadge_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.personnagenonjoueurbadgeProgressLayout,
                R.id.personnagenonjoueurbadgeListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.personnagenonjoueurbadge_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PersonnageNonJoueurBadgeListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PersonnageNonJoueurBadgeListLoader(this.getActivity(),
    ...
    public void onClickAdd() {
        Intent intent = new Intent(this.getActivity(),
                    PersonnageNonJoueurBadgeCreateActivity.class);
