/**************************************************************************
 * PersonnageNonJoueurBadgeCreateFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 * This fragment gives you an interface to create a PersonnageNonJoueurBadge.
 */
public class PersonnageNonJoueurBadgeCreateFragment extends HarmonyFragment
    ...
    public View onCreateView(
        ...
        final View view = inflater.inflate(
                R.layout.fragment_personnagenonjoueurbadge_create,
                container,
                false);
    ...
    public static class CreateTask extends AsyncTask<Void, Void, Uri> {
         ...
         * called
         */
        public CreateTask(final PersonnageNonJoueurBadgeCreateFragment fragment,
        ...
        protected Uri doInBackground(Void... params) {
            ...
            result = new PersonnageNonJoueurBadgeProviderUtils(this.ctx).insert(
                        this.entity);
        ...
        protected void onPostExecute(Uri result) {
            ...
            if (result != null) {
                ...
                builder.setMessage(
                        this.ctx.getString(
                                R.string.personnagenonjoueurbadge_error_create));
    ...
    public static class LoadTask extends AsyncTask<Void, Void, Void> {
        ...
        private ProgressDialog progress;
        /** Fragment. */
        private PersonnageNonJoueurBadgeCreateFragment fragment;
         ...
         * called
         */
        public LoadTask(final PersonnageNonJoueurBadgeCreateFragment fragment) {
            super();
            this.ctx = fragment.getActivity();
