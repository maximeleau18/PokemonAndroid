...
public class CombatManagerPlayerFragment extends Fragment {
    ...
    public void initializeComponent(View view) {
        ...
        this.pokemonLevel = (TextView) view.findViewById(R.id.combat_manager_player_pokemon_niveau_value);
        ...
        }else if(this.combatManager.getCombat().getDresseur2().getId() == this.dresseurConnected.getId()){
            int drawableResourceId = getResources().getIdentifier(
