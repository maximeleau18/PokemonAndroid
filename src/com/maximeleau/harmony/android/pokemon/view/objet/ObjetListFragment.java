/**************************************************************************
 * ObjetListFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** Objet list fragment.
 *
 * This fragment gives you an interface to list all your Objets.
 *
 * @see android.app.Fragment
 */
public class ObjetListFragment
        extends HarmonyListFragment<Objet>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected ObjetListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_objet_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.objetProgressLayout,
                R.id.objetListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.objet_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new ObjetListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new ObjetListLoader(this.getActivity(),
