/**************************************************************************
 * AttaqueListFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** Attaque list fragment.
 *
 * This fragment gives you an interface to list all your Attaques.
 *
 * @see android.app.Fragment
 */
public class AttaqueListFragment
        extends HarmonyListFragment<Attaque>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected AttaqueListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_attaque_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.attaqueProgressLayout,
                R.id.attaqueListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.attaque_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new AttaqueListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new AttaqueListLoader(this.getActivity(),
