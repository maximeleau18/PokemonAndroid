/**************************************************************************
 * DresseurListFragment.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** Dresseur list fragment.
 *
 * This fragment gives you an interface to list all your Dresseurs.
 *
 * @see android.app.Fragment
 */
public class DresseurListFragment
        extends HarmonyListFragment<Dresseur>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected DresseurListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_dresseur_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.dresseurProgressLayout,
                R.id.dresseurListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.dresseur_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new DresseurListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new DresseurListLoader(this.getActivity(),
