...
public abstract class TypeDePokemonEvolutionProviderUtilsBase
    ...
    public Uri insert(final TypeDePokemonEvolution item) {
        ...
        try {
            ...
            if (results[0] != null) {
                ...
                item.getEvolueEn().setId(Integer.parseInt(result.getPathSegments().get(1)));
                item.getEstEvolueEn().setId(Integer.parseInt(result.getPathSegments().get(2)));
            }
    ...
    public int delete(final TypeDePokemonEvolution item) {
        ...
        uri = Uri.withAppendedPath(uri, String.valueOf(item.getEvolueEn()));
        uri = Uri.withAppendedPath(uri, String.valueOf(item.getEstEvolueEn()));
    ...
    public TypeDePokemonEvolution query(final TypeDePokemonEvolution item) {
        return this.query(item.getEvolueEn(), item.getEstEvolueEn());
    }
     ...
     * @return TypeDePokemonEvolution
     */
    public TypeDePokemonEvolution query(final TypeDePokemon evolueEn,
                final TypeDePokemon estEvolueEn) {
        TypeDePokemonEvolution result = null;
        ContentResolver prov = this.getContext().getContentResolver();

        CriteriaExpression crits = new CriteriaExpression(GroupType.AND);
        crits.add(TypeDePokemonEvolutionContract.ALIASED_COL_EVOLUEEN_ID,
                    String.valueOf(evolueEn.getId()));
        crits.add(TypeDePokemonEvolutionContract.ALIASED_COL_ESTEVOLUEEN_ID,
