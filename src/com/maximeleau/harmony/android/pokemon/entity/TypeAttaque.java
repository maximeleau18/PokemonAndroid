...
public class TypeAttaque  implements Serializable , Parcelable {
     ...
     * @param parc The parcel to read from
     */
    public TypeAttaque(Parcel parc) {
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<TypeAttaque> CREATOR
        = new Parcelable.Creator<TypeAttaque>() {
        public TypeAttaque createFromParcel(Parcel in) {
            return new TypeAttaque(in);
        }
        
        public TypeAttaque[] newArray(int size) {
            return new TypeAttaque[size];
        }
    };
