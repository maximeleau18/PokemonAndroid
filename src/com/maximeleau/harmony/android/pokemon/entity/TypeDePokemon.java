...
public class TypeDePokemon  implements Serializable , Parcelable {
    ...
    public int getNumPokedex() {
     ...
     /**
     * Set the NumPokedex.
     * @param value the numPokedex to set
     */
    public void setNumPokedex(final int value) {
     ...
     * @param parc The parcel to read from
     */
    public TypeDePokemon(Parcel parc) {
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<TypeDePokemon> CREATOR
        = new Parcelable.Creator<TypeDePokemon>() {
        public TypeDePokemon createFromParcel(Parcel in) {
            return new TypeDePokemon(in);
        }
        
        public TypeDePokemon[] newArray(int size) {
            return new TypeDePokemon[size];
        }
    };
