/**************************************************************************
 * TypeAttaqueTestDBBase.java, pokemon Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 */
public abstract class TypeAttaqueTestDBBase extends TestDBBase {
    ...
    public void testCreate() {
        ...
        if (this.entity != null) {
            ...
            result = (int)this.adapter.insert(typeAttaque);
    ...
    public void testUpdate() {
        ...
        if (this.entity != null) {
            ...
            result = (int) this.adapter.update(typeAttaque);
